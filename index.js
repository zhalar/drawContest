...
const images = [
  ...
  {info: {UID: "706589168", author:"Nory07", title:"Tardé mucho en terminarlo, pero al fin lo terminé. Espero ganar, necesito protogemas para Yoimiya :'')", platform:"PC y PS4", discordID: "Nory07", socialNetwork: "nory__post"}, url: "https://media.discordapp.net/attachments/945509633609568286/1003937389087051796/yoimia.png?width=579&height=676", scores: {}},
  {info: {UID: "627722329", author:"Pam el Elote", title:"Me quise atrever con una pose dinámica y por eso me tardé con el boceto si no se vería deforme yoimigod", platform:"Celular", discordID: "Pam el Elote#7373", socialNetwork: "@MeiPam_art"}, url: "https://media.discordapp.net/attachments/945509633609568286/1003949421186265088/Yoimiya_Goooooood.png?width=572&height=676", scores: {}},
  {info: {UID: "606766496", author:"RINGO", title:"Sabría que vendrías jeje, ven apresurate que ya van a empezar los fuegos artificiales", platform:"PC", discordID: "RINGO", socialNetwork: ""}, url: "https://media.discordapp.net/attachments/945509633609568286/1003951068876648478/yoimiya.png?width=478&height=676", scores: {}}
];
